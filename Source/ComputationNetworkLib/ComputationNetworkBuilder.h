...
public:
	...
	ComputationNodePtr TranscriptionError(const ComputationNodePtr a, const ComputationNodePtr b, bool squashInputs, vector<size_t> tokensToIgnore, const std::wstring nodeName = L"");
